...
public class Client {
    public static final String TRAIN_FILE = "data/weather/train.csv"; 
    public static final String TEST_FILE = "data/weather/test.csv";      
    ...
    public static final Function<List<String>, Classifiable> CONVERTER = Weather::toClassifiable;
